...
public class Server extends JFrame implements ActionListener {
    ...
    public Server(MyServer myServer) {
        this();
    ...
    // main
    // ------------------------------------
    public static void main(String argv[], MyServer myServer) throws Exception {
        // create a Server object
        Server theServer = new Server(myServer);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (imagenb < VIDEO_LENGTH) {
            ...
            try {
                ...
                for (Integer x : this.myServer.sendToList) {
                    senddp = new DatagramPacket(packet_bits, packet_length,
                            InetAddress.getByName(IP.getHostAddress()), x); //id is port
